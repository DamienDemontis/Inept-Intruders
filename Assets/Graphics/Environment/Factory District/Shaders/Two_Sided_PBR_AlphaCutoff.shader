    ...
    SubShader {
        ...
        Pass {
                ...
                float facing : VFACE )
            {
                ...
                float node_4834 = ((_MainTex_var.a+_AlphaCutoff)*_AlphaCutoff);
                clip(node_4834 - 0.5);
////// Lighting:
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,node_4834);
...
/// Final Color:
                float3 finalColor = diffuse + specular;
                fixed4 finalRGBA = fixed4(finalColor * node_4834,0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
